...
export const CollectionSection = () => {
  return (
    <section className="mt-[120px] xl:mt-[192px] px-6 md:px-10 lg:px-0">
      ...
      <div className="mt-[13px] flex flex-col items-center w-full gap-12 md:gap-8 lg:gap-[30px] md:-mt-5 xl:-mt-4 md:relative md:z-30 xl:flex-row xl:max-w-[1110px] xl:mx-auto">
        {collection.map((item) => (
          <div
            key={item.id}
            className="flex flex-col items-center text-center text-dark-grey-blue md:flex-row md:justify-center md:gap-[36px]  md:text-left xl:flex-col lg:text-center w-full"
          >
            <div className="w-[200px] h-[151px] md:w-[255px] md:h-[193px] flex items-center justify-center">
              <img src={item.image} />
            </div>
