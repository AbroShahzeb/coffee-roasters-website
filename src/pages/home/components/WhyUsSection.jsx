...
export const WhyUsSection = () => {
  return (
    <section className="px-6 pb-[120px] md:pb-[144px] lg:pb-[200px] md:px-10 lg:px-20">
      <div className="bg-[#2C343E] md:bg-bg-steps bg-cover px-6 pt-16 pb-[64px] md:px-[74px] md:pt-[56px] md:pb-[70px]  rounded-t-[10px] lg:pt-[100px] lg:pb-[86px]">
      ...
      <div className="relative">
        <div className="absolute top-0 left-0 right-0 h-1/2 xl:h-[calc(50%+36px)] w-full rounded-b-[10px] z-10 bg-bg-steps bg-cover"></div>
